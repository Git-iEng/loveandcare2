      ...
      <div className="top_header" id="home">
        <div className="info-section-contact">
          <div className="info-box-contact">
            <a
              href="https://maps.app.goo.gl/6Jw6cUZZxyX7CEN29"
              target="_blank"
              rel="noreferrer"
            >
              <div className="icon-circle-contact bg-yellow-contact">
                <i className="fa fa-map-marker"></i>
              </div>
              <h4><strong>Address:</strong></h4>
              <p>
                Navale IT Zone, Office No. 501, 5th Floor, A-Wing, Near Navale
          ...
          <div className="info-box-contact">
            <a href="tel:+919168627258">
              <div className="icon-circle-contact bg-red-contact">
          ...
          <div className="info-box-contact">
            <a href="mailto:loveandcare.welfare@gmail.com">
              <div className="icon-circle-contact bg-blue-contact">
          ...
          <div className="info-box-contact">
            <a
              href="https://loveandcarefoundation.org/"
              target="_blank"
              rel="noreferrer"
            >
              <div className="icon-circle-contact bg-green-contact">
        ...
        <div className="contact-wrapper-contact">
          <div className="form-section-contact">
            ...
            {errorMessage && (
              <p style={{ color: "#ffb3b3", textAlign: "center", marginTop: "15px" }}>
                {errorMessage}
              </p>
            )}
          </div>
